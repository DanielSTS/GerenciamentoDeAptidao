...
public class ExtrairDados {
	...
	public void criarTopico(ArrayList<Double> pesos, ArrayList<String> codigoD){
        ...
        public ArrayList<String> getArrayAlunos(){
            return this.TopicosPorArea.get(this.contTopicosPorArea).getAlunosRk();
        }
        
        public ArrayList<Double> getArrayNotas(){
            return this.TopicosPorArea.get(this.contTopicosPorArea).getNotasRk();
        }
